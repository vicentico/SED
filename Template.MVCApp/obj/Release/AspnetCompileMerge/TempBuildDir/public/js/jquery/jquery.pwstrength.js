...
(function ($) {
    ...
    var options = {
        ...
        bootstrap3: false,
        errorMessages: {
            password_too_short: "<font color='red'>La Constraseña es muy corta</font>",
            same_as_username: "Su Contraseña no puede ser igual a su Nombre de Usuario"
        },
        scores: [17, 26, 40, 50],
    ...
    $.fn.pwstrength = function (method) {
        ...
        if (methods[method]) {
            ...
            $.error("El Método " + method + " no existe en jQuery.pwstrength");
        }
        return result;
    };
}(jQuery));
