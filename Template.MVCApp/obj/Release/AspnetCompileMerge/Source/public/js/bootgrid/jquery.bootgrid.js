...
(function ($, window, undefined) {
    ...
    */
    ...
    function prepareTable() {
        ...
        $parent.append("<div class='gridOverflow'></div>");

        var $wrapper = $parent.find("div.gridOverflow");
        $(this.element).detach().appendTo($wrapper);
        ...
        if (this.options.navigation !== 0) {
            ...
            if (actionItems.length > 0) {
                ...
                if (this.options.customButtons && this.options.customButtons.length > 0) {
                    var gridId = this.origin[0].id;
                    $.each(this.options.customButtons, function (index, item) {
                        var type_ = item.type;
                        ...
                        if (type_ === "button") {
                            ...
                            var button = "<button class='btn btn-" + style + "' type='button' id='" + gridId + "_" + id + "' title='" + tooltip + "'><span class='" + icon + "'></span></button>";

                            actions.append(button);
                        }

                        if (type_ === "toggle") {
                            var onStyle = item.style && item.style.length > 1 ? item.style[0] : "";
                            var offStyle = item.style && item.style.length > 1 ? item.style[1] : "";
                            var onIcon = item.icon && item.icon.length > 1 ? item.icon[0] : "";
                            var offIcon = item.icon && item.icon.length > 1 ? item.icon[1] : "";
                            var onLabel = item.label && item.label.length > 1 ? item.label[0] : "";
                            var offLabel = item.label && item.label.length > 1 ? item.label[1] : "";

                            var toggle_ = "<input id='" + gridId + "_" + id + "' type='checkbox' checked data-width='" + width + "' data-toggle='toggle' data-onstyle='" + onStyle + "' data-offstyle='" + offStyle + "' data-on='<i class=\"" + onIcon + " mr8\"></i>" + onLabel + "' data-off='<i class=\"" + offIcon + " mr8\"></i>" + offLabel + "' title='" + tooltip + "' />";

                            actions.append(toggle_);
                        }
                    });
                }
    ...
    function renderPagination() {
        if (this.options.navigation !== 0) {
            ...
            if (this.rowCount !== -1 && paginationItems.length > 0) {
                ...
                renderPaginationItem.call(this, pagination, "first", "<i class='icon-chevron-left'></i>", "first")
                    ._bgEnableAria(current > 1);
                renderPaginationItem.call(this, pagination, "prev", "<i class='icon-angle-left'></i>", "prev")
                    ._bgEnableAria(current > 1);
                ...
                renderPaginationItem.call(this, pagination, "next", "<i class='icon-angle-right'></i>", "next")
                    ._bgEnableAria(totalPages > current);
                renderPaginationItem.call(this, pagination, "last", "<i class='icon-chevron-right'></i>", "last")
                    ._bgEnableAria(totalPages > current);
    ...
    grid.defaults = {
        ...
        css: {
            ...
            footer: "bootgrid-footer container-fluid p8",
            header: "bootgrid-header container-fluid p8",
            icon: "icon glyphicon",
            ...
            left: "text-left",
            pagination: "paginator", // must be a unique class name or constellation of class names within the header and footer
        ...
        labels: {
            all: "Todo",
            infos: "Mostrando fila {{ctx.start}} a la {{ctx.end}} de {{ctx.total}}",
            loading: "Cargando...",
            noResults: "Sin datos",
            refresh: "Refrescar",
            search: "Filtrar",
        ...
        templates: {
            ...
            actionDropDown: "<div class=\"{{css.dropDownMenu}}\"><button class=\"btn btn-default dropdown-toggle\" type=\"button\" data-toggle=\"dropdown\"><span class=\"{{css.dropDownMenuText}}\">{{ctx.content}}</span> <span class=\"icon-chevron-down\"></span></button><ul class=\"{{css.dropDownMenuItems}}\" role=\"menu\"></ul></div>",
            actionDropDownItem: "<li><a data-action=\"{{ctx.action}}\" class=\"{{css.dropDownItem}} {{css.dropDownItemButton}}\">{{ctx.text}}</a></li>",
            actionDropDownCheckboxItem: "<li><label class=\"{{css.dropDownItem}}\"><input name=\"{{ctx.name}}\" type=\"checkbox\" value=\"1\" class=\"{{css.dropDownItemCheckbox}}\" {{ctx.checked}} /> {{ctx.label}}</label></li>",
            actions: "<div class=\"{{css.actions}}\"></div>",
            body: "<tbody></tbody>",
            cell: "<td class=\"{{ctx.css}}\" style=\"{{ctx.style}}\">{{ctx.content}}</td>",
            footer: "<div id=\"{{ctx.id}}\" class=\"{{css.footer}}\"><div class=\"row-fluid\"><div class=\"span6 pagination\"><p class=\"{{css.pagination}}\"></p></div><div class=\"span6 infoBar\"><p class=\"{{css.infos}}\"></p></div></div></div>",
            header: "<div id=\"{{ctx.id}}\" class=\"{{css.header}}\"><div class=\"row-fluid\"><div class=\"span12 actionBar p0\"><p class=\"{{css.search}}\"></p><p class=\"{{css.actions}}\"></p></div></div></div>",
            ...
            search: "<div class=\"{{css.search}}\"><div class=\"input-prepend\"><span class=\"add-on\"><i class='{{css.iconSearch}}'></i></span> <input type=\"text\" class=\"{{css.searchField}}\" placeholder=\"{{lbl.search}}\" /></div></div>",
            ...
            while (rowIds.length > 0 && !(!this.options.multiSelect && selectedRows.length === 1)) {
                ...
                if ($.inArray(id, this.selectedRows) === -1) {
                    for (i = 0; i < this.currentRows.length; i++) {
                        if (this.currentRows[i][this.identifier].toString() === id.toString()) {
